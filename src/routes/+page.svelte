...
<ul class="ml-5 my-3">
	...
	<LinkItem
		label="Thirst"
		link="https://www.mountaineers.org/books/books/thirst-2600-miles-to-home"
		type="book"
	/>
	<LinkItem
	...
	/>
	<LinkItem
		label="This is not a beautiful hiking video"
		link="https://www.youtube.com/watch?v=0PleoqR7VjY"
		type="video"
	/>
	<LinkItem
		label="It Is The People"
		link="https://www.youtube.com/watch?v=hiVbB7Pf2lY"
		type="video"
	/>
</ul>
